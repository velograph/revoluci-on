...
"Display a pager when more posts are found than specified in the 'Max' field. ",
"Main menu",
"5/6 1/6",
"1/6 5/6",
"6 Column layouts",
...
"Typography color",
"Choose between light and dark type. You will want to adjust this based on your background and overlay.",
"Section padding",
"Specify what form of padding should the section use.",
"Both",
"Use this block to add a Testimonials section.",
"Testimonial Author.",
"Testimonial Author Image.",
"Testimonial title.",
"Testimonial content.",
"Use this block to add a new testimonial.",
"Add one or more statistic.",
"Add Statistic",
"icon icon-hourglass",
"Icon representing this statistic.",
"284 HOURS",
"per project",
"Add a Stats section.",
"Team Member",
"Name of this team member.",
"Team Member Image.",
"Role",
"Use this block to add a new team member.",
"Enter a subtitle for the section.",
"Section title.",
"Title Icon.",
"Section content.",
"Use this block to add a Services section.",
...
"Text of the button.",
"Enquire",
"Use this block to add a new service.",
"Text of the quote.",
"Author of the quote.",
"Add a Quote section.",
"Process",
"Use this block to add a Process section.",
"Call to action",
"Text displayed at the bottom of this section.",
"Text of the button",
"Button url",
"Link of the button.",
"PricingTables",
"Use this block to add a Pricing section.",
"Plan",
"Pricing plan title.",
"Beginner",
"Superscript",
"Displayed in smaller font, above the price.",
"\$",
"Plan price.",
"Subscript",
"Displayed in smaller font, below the price.",
"pm.",
"Add one or more feature describing this plan.",
"Add Feature",
"100 Unique Logins",
"Text of the button displayed at the bottom of the table.",
"Link of the button displayed at the bottom of the table.",
"Should this table be featured.",
"Use this block to add a new pricing table.",
"Add a Portfolio section showing projects.",
"Phase",
"Phase Icon.",
"Title of the phase.",
"Design",
"Steps",
"Add one or more step to this phase.",
"Add Step",
"Ask questions",
"Use this block to add a new phase.",
"Use this block to add Logos section.",
"Optional link for the logo.",
"Upload logo here.",
"Use this block to add a new logo.",
"Add one or more feature.",
"Featured image",
"Featured image of the section.",
"Button 1 link",
"Button 1 text",
"Purchase",
"Button 2 link",
...
"Follow",
"Buttons separator",
"Text displayed between two buttons.",
"Add a Feature section.",
"Add a Blog section showing posts.",
"Blog Alternate",
"Columns Number",
"Choose between single or two-columns layout.",
"Add an alternate Blog section showing posts.",
"About",
"Use this block to add an About section.",
"Enter the button text here",
"Open in new window",
"Should the url be opened in new window or not.",
"Page",
"of",
"Continue Reading..",
...
"Image displayed in background of the footer.",
"Address displayed in footer.",
"Address link",
"Link on Address displayed in footer.",
"E-mail address displayed in footer.",
"Email link",
"Link onE-mail address displayed in footer.",
"Phone number",
"Phone number displayed in footer.",
"Phone number link",
"Link on Phone number displayed in footer.",
"Social Network Name",
"Copyright",
"This is the footer copyright message.",
"Header image",
"Image displayed on top of the blog posts.",
"Header title",
"Title displayed on top of the header.",
"Header subtitle",
"Subtitle displayed on top of the header.",
"Splash",
"Splash section",
"Specify whether you want the splash section on top of this page or not.",
"Off",
"On",
"Splash type",
"Should the url be opened in new window?",
"Gallery used for splash area. Captions can be added when editing that gallery.",
"Headlines type",
"Simple",
"Detailed",
"Left subtitle",
"Left subtitle of the slide (used only in splash).",
"Right subtitle",
"Right subtitle of the slide (used only in splash).",
"A small logo displayed on top of splash, has to be 100px wide.",
"Client Logo",
"Featured Image",
"Header background",
"Posted by",
"Category: %s",
"Tag: %s",
"The gallery you have selected is empty, please select the gallery that has at least one image in it.",
"Search..",
"GO",
"in ",
